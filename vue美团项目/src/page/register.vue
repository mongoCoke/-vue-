  ...
  <div class="page-register">
    <div class="header">
      <header>
        ...
        <img src="@/assets/img/logo.jpg" alt="" class="site-logo">
        <div class="login">
          <span class="bold">已有在路上账号？</span>
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('registerForm')">同意以下协议并注册</el-button>
            <a class="f1" href="http://www.meituan.com/about/terms" target="_blank">《在路上用户协议》</a>
        </el-form-item>
      </el-form>
    </div>
    <footer class="footer--mini">
    <p class="copyright">
        ©<a class="f1" href="https://www.meituan.com">zailushang.com</a>&nbsp;
